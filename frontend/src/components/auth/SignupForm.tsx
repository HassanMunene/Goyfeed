			...
			<form onSubmit={handleSubmit} className="space-y-4">
						...
						>
							<div className="flex gap-1 mb-1">
								{[1, 2, 3, 4].map((i) => (
									<div
										key={i}
										className={`h-1 flex-1 rounded-full ${passwordStrength >= i
				...
				<div className="flex items-start pt-2">
					...
					<label htmlFor="terms" className="ml-2 text-sm text-gray-500">
						I agree to the <Link to="/terms" className="text-[#4f46e5] hover:underline">Terms of Service</Link> and <Link to="/privacy" className="text-[#4f46e5] hover:underline">Privacy Policy</Link>
					</label>
				</div>
